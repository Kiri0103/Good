...
- **実装済み**: 様式４の１（変圧器・線路）の連系用／その他変圧器、様式３の４（逆変換装置＝PCS）。
- **未実装（順次拡張）**: 様式１（基本情報）, 様式２（発電設備概要）, 様式４の２（受電設備）等。
...
- [x] **AK1T 様式転記**: 様式４の１（変圧器・線路）, 様式３の４（逆変換装置＝PCS）
- [ ] **AK1T 様式転記（拡張）**: 様式１（基本情報）/２（発電設備概要）/４の２（受電設備）等
