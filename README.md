...
- **対象外**: 様式３の１〜３/５（同期機・誘導機等＝他電源種別用）, 様式５系・様式６（単線結線図・配置図・土地調査などの**作図/別紙シート**）。これらはデータ転記ではなく作図機能で対応予定。
...
- [x] **AK1T 様式転記（データ系を網羅）**: 様式１, 様式２, 様式３の４（PCS）, 様式４の１（変圧器・線路）, 様式４の２（受電設備）, 様式４の３（監視制御）
